...
// ESM compatibility: Create require function for Node.js environments
let nodeRequire = null;
if (typeof process !== 'undefined' && process.versions && process.versions.node) {
  try {
    // Dynamic import of createRequire for ESM compatibility
    const { createRequire } = await import('module');
    nodeRequire = createRequire(import.meta.url);
  } catch (e) {
    // Fallback: try to access crypto directly
    try {
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_require_60cc747a6bc5215a = function() { return handleError(function () {
        // ESM compatibility: use nodeRequire instead of module.require
        if (nodeRequire) {
            return nodeRequire;
        }
